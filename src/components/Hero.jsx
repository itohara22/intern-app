const Hero = () => {
  return (
    <div className=" text-black px-4 mt-20 ">
      <div className="bg-violet-100 mx-auto grid sm:grid-cols-2 place-items-center p-20 md:px-[20vw] xl:px-[15vw] my-2 rounded-2xl  min-w-full min-h-[80vh] ">
        <div className=" pr-8">
          <p className="text-sm ">My App</p>
          <h1 className="text-5xl lg:text-6xl font-bold mt-2 mb-8">
